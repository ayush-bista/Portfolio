...
const services = [
  {
    number: "01",
    title: "DESIGN",
    description: "Efficient, knowledgeable, & exceptional design experiences. Pixel-perfect execution with creative excellence across all platforms.",
    image: portfolio2,
  ...
  },
  {
    number: "02",
    title: "CODE",
    description: "Clean, performant code that brings designs to life with modern technologies, best practices, and scalable architecture.",
    image: portfolio4,
  ...
  },
  {
    number: "03",
    title: "BRANDING",
    description: "Creating memorable brand identities that resonate with your target audience through strategic visual storytelling and cohesive design systems.",
    image: portfolio1,
